...
<div id="container">
  ...
  <div id="main">
    <div id="content_left">
      <h1>Thank you!</h1>
      <p>Any changes you submitted have been made. You should receive a confirmation email for changing any account information. </p>
      <p></p>
    </div>
    <div id="content_right">
      <h4>&nbsp;</h4>
      <div class="item_box">
        <div align="center"><img src="../images/checkmark.png" width="176" height="177" alt="Registration success"/><br />
        </div>
      </div>
    </div>
