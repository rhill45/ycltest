...
<title>Password Reset || mblistings.com</title>
      ...
      <form name="form1" method="post" action="lostpw.php">
        <table border="0" cellpadding="4" cellspacing="0" align="left">
          <tr>
            ...
            <td><input name="psswrd1" type="text" id="txtNewPassword" value="<? echo $psswrd1; ?>"></td>
            <td rowspan="2">    <div class="registrationFormAlert" id="divCheckPasswordMatch">
</div></td>
          </tr>
                    <tr>
            <td align="left" valign="top">Re-enter Password</td>
            <td><input name="psswrd2" type="text" id="txtConfirmPassword" onChange="checkPasswordMatch()" value="<? echo $psswrd2; ?>"></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><input name="recover" type="hidden" id="recover" value="recover"/>
              <input type="submit" name="Submit" value="Reset My Password!"/></td>
          </tr>
        </table>
      </form>
...
$(document).ready(function () {
   $("#txtConfirmPassword").keyup(checkPasswordMatch);
    ...
    <div id="content_right">
      <div class="item_box">
        <div align="center"><img src="../images/lostpw.png" alt="mblistings dot com commercial real estate Robert Buzzeo Michael Braccia" width="174" height="136" /><br />
        </div>
      </div>
    </div>
